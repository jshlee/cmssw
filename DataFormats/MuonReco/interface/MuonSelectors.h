...
namespace muon {
   ...
   enum SelectionType {
      ...
      TrackerGEMLoose = 25                         // checks isTrackerGEM flag (require matched to GEM segments)
   };
   ...
   //                               Support functions
   // 
   enum AlgorithmType { TMLastStation, TM2DCompatibility, TMOneStation, RPCMu, TrackerGEM };
