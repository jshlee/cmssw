...
# with command line options: step3 --conditions auto:phase1_2017_realistic -n -1 --era Run2_2017 --eventcontent DQM --runUnscheduled -s VALIDATION:@baseValidation+@muonOnlyValidation --datatier DQMIO --geometry DB:Extended --filein file:step3.root --fileout file:step31.root --python Val_Run2_2017_2.py --no_exec
