...
# with command line options: step3 --conditions auto:phase2_realistic -n -1 --era Phase2C2_timing --eventcontent FEVTDEBUGHLT,DQM --runUnscheduled -s VALIDATION:@baseValidation+@muonOnlyValidation --datatier GEN-SIM-RECO,DQMIO --geometry Extended2023D4 --filein file:step3.root --fileout file:step31.root --python Val_2023D4Timing_2.py --no_exec
