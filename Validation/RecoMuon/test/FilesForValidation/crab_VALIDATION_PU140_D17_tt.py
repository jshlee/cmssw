...
config = config()
config.General.requestName = 'Val_911_PU140_D17_tt_8'
config.General.workArea = 'crabProjects_VAL_PU140_D17_tt_8'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName ='Val_2023D17_2.py'
config.Data.inputDataset='/RelValTTbar_14TeV/CMSSW_9_1_1-PU25ns_91X_upgrade2023_realistic_v1_D17PU140-v1/GEN-SIM-RECO'
