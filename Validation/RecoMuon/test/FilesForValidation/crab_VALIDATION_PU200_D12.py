...
config = config()
config.General.requestName = 'Val_910_pre3_PU200_D12_1'
config.General.workArea = 'crabProjects_VAL_PU200_D12_1'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName ='Val_2023D12_2.py'
config.Data.inputDataset='/RelValZMM_14/CMSSW_9_1_0_pre2-PU25ns_90X_upgrade2023_realistic_v9_D12PU200-v1/GEN-SIM-RECO'
