...
config = config()
config.General.requestName = 'Val_911_RUN2_2017_PU_dsa_5'
config.General.workArea = 'crabProjects_VAL_RUN2_2017_PU_dsa_5'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName ='Val_Run2_2017_2.py'
config.Data.inputDataset='/RelValTenDisplacedMuonsDxy_0_500/CMSSW_9_1_1_patch1-PU25ns_91X_upgrade2017_realistic_v3_rsb-v1/GEN-SIM-RECO'
