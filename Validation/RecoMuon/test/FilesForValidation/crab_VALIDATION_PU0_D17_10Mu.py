...
config = config()
config.General.requestName = 'Val_911_PU0_D17_10Mu_10'
config.General.workArea = 'crabProjects_VAL_PU0_D17_10Mu_10'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName ='Val_2023D17_2.py'
config.Data.inputDataset='/RelValTenMuExtendedE_0_200/CMSSW_9_1_1-91X_upgrade2023_realistic_v1_D17-v1/GEN-SIM-RECO'
