...
config = config()
config.General.requestName = 'Val_911_RUN2_2017_PU_10Mu_8'
config.General.workArea = 'crabProjects_VAL_RUN2_2017_PU_10Mu_8'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName ='Val_Run2_2017_2.py'
config.Data.inputDataset='/RelValZMM_13/CMSSW_9_1_0_pre3-PU25ns_91X_upgrade2017_realistic_v3-v1/GEN-SIM-RECO'
