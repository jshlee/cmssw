...
process = cms.Process("trackerGEM")
...
process.localreco_step  = cms.Path(process.muonlocalreco+process.gemRecHits+process.gemSegments+process.me0LocalReco+process.trackerlocalreco)
...
process.globalreco_step = cms.Path(process.offlineBeamSpot*process.MeasurementTrackerEvent*process.siPixelClusterShapeCache*process.PixelLayerTriplets*process.recopixelvertexing*
                                   process.standalonemuontracking*process.trackingGlobalReco*process.vertexreco*process.me0MuonReco*process.trackerGEM)#*process.muonGlobalReco)
